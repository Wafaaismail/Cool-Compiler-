...
public class myVisitor extends CoolBaseVisitor<Value> {
    ...
    public static class SymbolTable {
        ...
        protected SymbolTable outerSymbolTable = null;
...
//            System.err.println(value + "  is added in symbol table");
...
//                    System.err.println(value + "  is found in symbol table");
                    return true;
                }
            }
//            System.err.println(value + "  is NOT found in symbol table");
    ...
    public Value visitAssignment(CoolParser.AssignmentContext ctx) {
        ...
        try {
            writer.write(temp.toString() + " = " + value);
            writer.newLine();
            writer.write(id.toString() + " = " + temp.toString());
            writer.newLine();
     ...
     */
    @Override
    public Value visitString(CoolParser.StringContext ctx) {
     ...
     */
    @Override
    public Value visitFalse(CoolParser.FalseContext ctx) {
     ...
     */
    @Override
    public Value visitTrue(CoolParser.TrueContext ctx) {
     ...
     */
    @Override
    public Value visitId(CoolParser.IdContext ctx) {
...
//        }
     ...
     */
    @Override
    public Value visitParentheses(CoolParser.ParenthesesContext ctx) {
     ...
     */
    @Override
    public Value visitBoolNot(CoolParser.BoolNotContext ctx) {
     ...
     */
    @Override
    public Value visitPlus(CoolParser.PlusContext ctx) {
     ...
     */
    @Override
    public Value visitMinus(CoolParser.MinusContext ctx) {
     ...
     */
    @Override
    public Value visitMultiplication(CoolParser.MultiplicationContext ctx) {
     ...
     */
    @Override
    public Value visitDivision(CoolParser.DivisionContext ctx) {
     ...
     */
    @Override
    public Value visitLessOREqual(CoolParser.LessOREqualContext ctx) {
     ...
     */
    @Override
    public Value visitSmallerThan(CoolParser.SmallerThanContext ctx) {
     ...
     */
    @Override
    public Value visitNegative(CoolParser.NegativeContext ctx) {
     ...
     */
    @Override
    public Value visitEqual(CoolParser.EqualContext ctx) {
        Value left = this.visit(ctx.expr(0));
        Value right = this.visit(ctx.expr(1));
        Temp temp = new Temp();
        System.out.println(temp.toString() + " = " + left + " == " + right);
     ...
     */
    @Override
    public Value visitIf(CoolParser.IfContext ctx) {
    ...
    @Override
    public Value visitIsvoid(CoolParser.IsvoidContext ctx) {
        Temp temp = new Temp();
     ...
     */
    @Override
    public Value visitWhile(CoolParser.WhileContext ctx) {
     ...
     */
    @Override
    public Value visitCase(CoolParser.CaseContext ctx) {
    ...
    @Override
    public Value visitBlock(CoolParser.BlockContext ctx) {
...
//            System.err.println("table id pushed" + SymbolTable.scopeStack.peek().toString());
     ...
     */
    @Override
    public Value visitProperty(CoolParser.PropertyContext ctx) {
        Temp temp = new Temp();
        if (SymbolTable.scopeStack.empty()) { // لو الستاك فاضي يبقى دا أول سكوب outerTable= null
            SymbolTable.scopeStack.push(new SymbolTable(null));
//            SymbolTable.scopeStack.peek().put("ID", ctx.ID().getText());
        ...
        if (SymbolTable.scopeStack.peek().symbolTable.containsValue(ctx.ID().getText())) {
            ...
            if (ctx.getChildCount() > 3) {
                ...
                System.err.println(ctx.ID().getText() + "is added to the table");
            }
    ...
    @Override
    public Value visitMethod(CoolParser.MethodContext ctx) {
    ...
    @Override
    public Value visitMethodCall(CoolParser.MethodCallContext ctx) {
        Temp t = new Temp();
     ...
     */
    @Override
    public Value visitOwnMethodCall(CoolParser.OwnMethodCallContext ctx) {
        Temp t = new Temp();
        return new Value(t.toString());
    }
