...
public class CoolBaseVisitor<T> extends AbstractParseTreeVisitor<T> implements CoolVisitor<T> {
	 ...
	 */
	@Override public T visitStats(CoolParser.StatsContext ctx) { return visitChildren(ctx); }
	/**
	 * {@inheritDoc}
	 *
	 * <p>The default implementation returns the result of calling
	 * {@link #visitChildren} on {@code ctx}.</p>
	 */
	@Override public T visitStat(CoolParser.StatContext ctx) { return visitChildren(ctx); }
}